# Коннектор к системе Яндекс.Директ для Microsoft Power BI
...
4) Нажмите на кнопку "Получить данные", в поиске найдите коннектор Yandex.Direct и укажите необходимые параметры.
